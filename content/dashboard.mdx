...
- **연결 (Connection)** — Niklas Luhmann의 [Zettelkasten](https://en.wikipedia.org/wiki/Zettelkasten)과 Ahrens(2017)가 강조하는 노트 간 링크 밀도. 고립 노트는 다시 꺼내질 가능성이 낮습니다.
...
원격 AI 세션(remote agent — 본인 컴퓨터가 아닌 Anthropic 클라우드에서 잠깐 떠서 일하는 별도 세션)을 정한 시점에 띄워서, 본인 학습 저장소를 가져오고 위 세 요소(Coverage·Momentum·Connection)를 만들어 Gmail로 보냅니다.
